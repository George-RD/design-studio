...
The bounded v1.7 contraction is governed by [#74](https://github.com/George-RD/design-studio/issues/74). Completed implementation evidence remains linked through [#75](https://github.com/George-RD/design-studio/issues/75) for the runtime seam and [#76](https://github.com/George-RD/design-studio/issues/76) for public-source installation.

Repository-owned v1.7 work is merged and exact-head verified at `d6614f81e6d487ba2f20bca0aff7fe7e5c3d3e3c`; the frozen publication line is `release/v1.7.0`. [#77](https://github.com/George-RD/design-studio/issues/77) and [#78](https://github.com/George-RD/design-studio/issues/78) are parked `ready-for-human` for repository metadata, tag, GitHub Release, and final acceptance publication in a capable environment. Prepared release evidence remains in [`docs/releases/v1.7.0.md`](docs/releases/v1.7.0.md).

GitHub issue state, labels, and blockers determine executable work; this map does not restate their checklists.
...
[#89](https://github.com/George-RD/design-studio/issues/89) is the promoted implementation front door from the frozen v1.7 baseline. The remaining #88 child issues follow their declared immediate blockers. External v1.7 publication does not block safe v1.8 implementation; final v1.8 publication remains ordered through [#98](https://github.com/George-RD/design-studio/issues/98), which depends on #78 as well as the completed v1.8 proof graph.

The bounded target is v1.8.0 with exact-head workflow, composition, design-system, install, and release evidence.
