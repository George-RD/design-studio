...
After accepted proof, `complete_extension` publishes the accepted surface only. Write `extensionResult` with before/after authority evidence and the actual surface result:
