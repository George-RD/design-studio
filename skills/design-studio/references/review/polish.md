...
2. Run the local mechanical gate in `../quality-gates.md`.
3. When browser-grounded, route read-only lenses: always `slop.md`, `hierarchy.md`, `a11y.md`; add `interaction.md` only for matching interaction/motion signals.
