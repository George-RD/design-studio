...
Mechanical proof includes captured detector observations and its unmodified snapshot, bound to the accepted tree. Verification recomputes the snapshot rather than trusting a claimed clean ID. Browser proof cannot change Document-bound token values without page acceptance.
