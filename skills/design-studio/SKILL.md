...
Load `invocation.md` to map host input and isolated roles. Then load `references/context.md`, `references/runtime-contract.md` and `references/runtime-integrity.md` before planning.
...
Run `workflow.yaml` end to end. Invoke deterministic operations through `references/runtime-contract.md`; host adapters translate capabilities and inputs but do not own a second runtime policy.
...
Execute `references/review/polish.md` through `references/runtime-contract.md` without `workflow.yaml`.
...
| Deterministic runtime operations and failure semantics | `references/runtime-contract.md` |
