...
Design Studio can optionally invoke the deterministic detector distributed by the [Impeccable](https://github.com/pbakaus/impeccable) project.
...
- When installed by the user, Design Studio calls the public `impeccable detect` interface and consumes its JSON output.
